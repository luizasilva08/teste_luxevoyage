...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Acesse sua conta Luxe Voyage e continue planejando sua próxima viagem.",
      },
    ],
  }),
  component: AuthPage,
          ...
          <form className="mt-10 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-navy-foreground/80">
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-navy-foreground/30 bg-transparent accent-gold"
                />
                Manter-me conectado
              </label>
